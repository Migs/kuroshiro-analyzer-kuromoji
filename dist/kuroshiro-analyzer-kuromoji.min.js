...
"use strict";var DictionaryBuilder=require("./dict/builder/DictionaryBuilder"),DictionaryLoader=require("./loader/NodeDictionaryLoader"),kuromoji={loader:function(r){return new DictionaryLoader(r)},builder:function(){return new DictionaryBuilder}};module.exports=kuromoji;

},{"./dict/builder/DictionaryBuilder":13,"./loader/NodeDictionaryLoader":15}],15:[function(require,module,exports){
"use strict";var DictionaryLoader=require("./DictionaryLoader");function BrowserDictionaryLoader(r){DictionaryLoader.call(this,r)}BrowserDictionaryLoader.prototype=Object.create(DictionaryLoader.prototype),BrowserDictionaryLoader.prototype.loadArrayBuffer=function(r,o){var e=new XMLHttpRequest;e.open("GET",r,!0),e.responseType="arraybuffer",e.onload=function(){this.status>0&&200!==this.status?o(e.statusText,null):o(null,new Uint8Array(this.response).buffer)},e.onerror=function(r){o(r,null)},e.send()},module.exports=BrowserDictionaryLoader;

},{"./DictionaryLoader":16}],16:[function(require,module,exports){
"use strict";var path=require("path"),async=require("async"),DynamicDictionaries=require("../dict/DynamicDictionaries"),Tokenizer=require("../Tokenizer");function DictionaryLoader(n){this.dic=new DynamicDictionaries,this.dic_path=n.dic_path||"dict/"}DictionaryLoader.prototype.loadArrayBuffer=function(n,i){throw new Error("DictionaryLoader#loadArrayBuffer should be overwrite")},DictionaryLoader.prototype.load=function(n){var i=this.dic,r=this.dic_path,t=this.loadArrayBuffer;async.parallel([function(n){async.map(["base.dat","check.dat"],function(n,i){t(path.join(r,n),function(n,r){if(n)return i(n);i(null,r)})},function(r,t){if(r)return n(r);var a=new Int32Array(t[0]),o=new Int32Array(t[1]);i.loadTrie(a,o),n(null)})},function(n){async.map(["tid.dat","tid_pos.dat","tid_map.dat"],function(n,i){t(path.join(r,n),function(n,r){if(n)return i(n);i(null,r)})},function(r,t){if(r)return n(r);var a=new Uint8Array(t[0]),o=new Uint8Array(t[1]),e=new Uint8Array(t[2]);i.loadTokenInfoDictionaries(a,o,e),n(null)})},function(n){t(path.join(r,"cc.dat"),function(r,t){if(r)return n(r);var a=new Int16Array(t);i.loadConnectionCosts(a),n(null)})},function(n){async.map(["unk.dat","unk_pos.dat","unk_map.dat","unk_char.dat","unk_compat.dat","unk_invoke.dat"],function(n,i){t(path.join(r,n),function(n,r){if(n)return i(n);i(null,r)})},function(r,t){if(r)return n(r);var a=new Uint8Array(t[0]),o=new Uint8Array(t[1]),e=new Uint8Array(t[2]),c=new Uint8Array(t[3]),u=new Uint32Array(t[4]),d=new Uint8Array(t[5]);i.loadUnknownDictionaries(a,o,e,c,u,d),n(null)})}],function(r){n(r,new Tokenizer(i))})},module.exports=DictionaryLoader;
